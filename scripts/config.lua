...
M.params = {
	...
	slot_tiers = {
		{ color = vmath.vector4(0.85, 0.45, 0.40, 1.0), score = 1, weight = 16 },
		{ color = vmath.vector4(0.90, 0.70, 0.30, 1.0), score = 2, weight = 8 },
		{ color = vmath.vector4(0.90, 0.85, 0.40, 1.0), score = 3, weight = 4 },
		{ color = vmath.vector4(0.50, 0.85, 0.55, 1.0), score = 4, weight = 2 },
		{ color = vmath.vector4(0.40, 0.75, 0.85, 1.0), score = 5, weight = 1 },
	},
